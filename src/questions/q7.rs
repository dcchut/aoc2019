...
use aoc2019::ic::io::{ICInput, Queue};
use aoc2019::ic::orchestrator::ICInterpreterOrchestrator;
...
fn max_thruster_signal() {
    ...
    assert_eq!(q7.part1(&ProblemInput::from(vec!["3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0"])), 43210);
    assert_eq!(q7.part1(&ProblemInput::from(vec!["3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0"])), 54321);
